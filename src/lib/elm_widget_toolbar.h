...
struct _Elm_Toolbar_Data
{
   ...
   Elm_Toolbar_Item_Data                *selected_item; /**< a selected item by mouse click, return key, api, and etc. */
   Elm_Toolbar_Item_Data                *focused_item; /**< a focused item by keypad arrow or mouse. This is set to NULL if widget looses focus. */
   Elm_Toolbar_Item_Data                *last_focused_item; /**< This records the last focused item when widget looses focus. This is required to set the focus on last focused item when widgets gets focus. */
