...
struct _Elm_List_Data
{
   ...
   Elm_List_Item_Data                   *last_selected_item;
   Elm_List_Item_Data                   *focused_item; /**< a focused item by keypad arrow or mouse. This is set to NULL if widget looses focus. */
   Elm_List_Item_Data                   *last_focused_item; /**< This records the last focused item when widget looses focus. This is required to set the focus on last focused item when widgets gets focus. */
