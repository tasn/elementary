...
_elm_win_focus_in(Ecore_Evas *ee)
{
   ...
   eo_do(obj, eo_event_callback_call(ELM_WIN_EVENT_FOCUS_IN, NULL));
...
_elm_win_focus_out(Ecore_Evas *ee)
{
   ...
   eo_do(obj, eo_event_callback_call(ELM_WIN_EVENT_FOCUS_OUT, NULL));
...
_elm_win_delete_request(Ecore_Evas *ee)
{
   ...
   if (_elm_config->atspi_mode)
     eo_do(obj, eo_event_callback_call
       (ELM_INTERFACE_ATSPI_WINDOW_EVENT_WINDOW_DESTROYED, NULL));
