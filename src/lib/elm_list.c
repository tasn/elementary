...
EOLIAN static Eo *
_elm_list_elm_interface_atspi_component_accessible_at_point_get(Eo *obj, Elm_List_Data *_pd EINA_UNUSED, Eina_Bool screen_coords, int x, int y)
{
   Eo *ret;
   eo_do_super(obj, ELM_LIST_CLASS, ret = elm_interface_atspi_component_accessible_at_point_get(screen_coords, x, y));
   ...
   return eo_do_ret(obj, ret, elm_obj_list_at_xy_item_get(x, y, NULL));
}
