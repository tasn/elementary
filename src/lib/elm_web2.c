...
static Eina_Bool
_fullscreen_accept(void *data EINA_UNUSED,
...
static Eina_Bool
_fullscreen_deny(void *data EINA_UNUSED,
      Eo *obj EINA_UNUSED, const Eo_Event_Description *desc EINA_UNUSED, void *event_info EINA_UNUSED)
{
   Evas_Object *ewk = data;
...
static Eina_Bool
_bt_close(void *data EINA_UNUSED,
      Eo *obj EINA_UNUSED, const Eo_Event_Description *desc EINA_UNUSED, void *event_info EINA_UNUSED)
{
   Dialog_Data *d = data;
...
static Eina_Bool
_view_smart_url_changed_cb(void *data EINA_UNUSED,
      Eo *obj EINA_UNUSED, const Eo_Event_Description *desc EINA_UNUSED, void *event_info EINA_UNUSED)
{
