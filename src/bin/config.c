                    ...
                    Evas_Object *bx0)
{
   ...
   elm_settingspane_item_attach_panel(it, _status_config_sizing);
   elm_settingspane_item_keywords_set(it, "size, scale");

   it = elm_settingspane_item_append(settings, NULL, "Theme", NULL);
   elm_settingspane_item_attach_panel(it, _status_config_themes);
   ...
   elm_settingspane_item_attach_panel(it, _status_config_fonts);
   ...
   elm_settingspane_item_attach_panel(it, _status_config_profiles);
   ...
   elm_settingspane_item_attach_panel(it, _status_config_scrolling);
   ...
   elm_settingspane_item_attach_panel(it, _status_config_rendering);
   ...
   elm_settingspane_item_attach_panel(it, _status_config_caches);
   ...
   elm_settingspane_item_attach_panel(it, _status_config_audio);
   ...
   elm_settingspane_item_attach_panel(it, _status_config_focus);
   ...
   elm_settingspane_item_attach_panel(it, _status_config_etc);
   elm_settingspane_item_image_set(it, NULL, "zoom-fit-best");
