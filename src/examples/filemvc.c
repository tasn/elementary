...
//   elm_box_horizontal_set(box, EINA_TRUE);
   ...
   eo_do(priv.treemodel, emodel_load());

   //treeview
   genlist = elm_genlist_add(win);
   priv.treeview = eo_add(ELM_VIEW_LIST_CLASS, NULL, elm_view_list_constructor(genlist, ELM_GENLIST_ITEM_TREE, NULL));
   ...
   priv.formview = eo_add(ELM_VIEW_FORM_CLASS, NULL, elm_view_form_constructor(NULL));
