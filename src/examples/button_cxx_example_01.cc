...
elm_main(int argc, char *argv[])
{
  ...
  ::elm_icon icon_up(efl::eo::parent = win);
  icon_up.standard_set("arrow_up");
  up.content_set("icon", icon_up);

  ::elm_box box_inferior(efl::eo::parent = win);
  ...
  box_inferior.visibility_set(true);
  ...
  ::elm_icon icon_left(efl::eo::parent = win);
  ...
  ::elm_icon icon_mid(efl::eo::parent = win);
  ...
  ::elm_icon icon_right(efl::eo::parent = win);
  ...
  ::elm_icon icon_down(efl::eo::parent = win);
